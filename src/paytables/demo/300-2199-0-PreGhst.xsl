			...
			<lxslt:component prefix="my-ext" functions="formatJson,retrievePrizeTable,getType">
				<lxslt:script lang="javascript">
					...
					function formatJson(jsonContext, translations, prizeTable, prizeValues, prizeNamesDesc)
					{
						...
						r.push('</tr>');
						r.push('<tr class="tablehead">');
						r.push('<td style="padding-right:10px">');
						...
						for (var turnIndex = 0; turnIndex < mainData.length; turnIndex++)
						{
							...
							r.push('<td class="tablebody" style="padding-right:10px">' + mainSymbolText + '</td>');
							r.push('<td class="tablebody" style="padding-right:10px">' + secondSymbolText + '</td>');
							r.push('<td class="tablebody" style="padding-right:10px">' + outcomeText + '</td>');
						...
						if (mainBonusCount == 4)
						{
							...
							for (var turnIndex = 0; turnIndex < bonusData.length; turnIndex++)
							{
								...
								r.push('<tr>');
								r.push('<td class="tablebody" style="padding-right:10px">' + (turnIndex+1).toString() + '</td>');
								r.push('<td class="tablebody" style="padding-right:10px">' + bonusSymbolText + '</td>');
								r.push('<td class="tablebody" style="padding-right:10px">' + outcomeText + '</td>');
								r.push('<td class="tablebody" style="padding-right:10px">' + prizeText + '</td>');
								r.push('</tr>');
							}
