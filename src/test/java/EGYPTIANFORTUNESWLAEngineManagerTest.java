...
public class EGYPTIANFORTUNESWLAEngineManagerTest
{
	...
	{
		logger = Logger.getLogger(EGYPTIANFORTUNESWLAEngineManagerTest.class);
		gameParams = XMLUtil.parseResource("paymodel/EGYPTIANFORTUNESWLAIW/GameParams.xml").getDocumentElement();
		previousOutcome = XMLUtil.parseResource("paymodel/EGYPTIANFORTUNESWLAIW/InitOutcome.xml").getDocumentElement();
